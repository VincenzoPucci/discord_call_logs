...
computing_error: int= 0
"""Number of messages skip for computing error"""
...
def calculate_data():
    ...
    global total_amount_of_call, total_call_time_hours, total_call_time_days, average_call_time_hours, computing_error
